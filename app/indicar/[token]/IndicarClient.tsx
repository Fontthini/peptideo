...
export default function IndicarClient({ token, medicoNome }: { token: string; medicoNome: string }) {
  const [form, setForm] = useState({ nome: '', sobrenome: '', whatsapp: '', email: '', endereco: '' });
      ...
      <section style={{ padding: '56px 24px 80px', maxWidth: 560, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ color: '#6b7280', fontSize: 15, lineHeight: 1.6 }}>
            Preencha seus dados para iniciar seu atendimento na PeptideZ Health.
          </p>
        </div>
