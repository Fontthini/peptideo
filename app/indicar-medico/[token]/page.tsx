...
import IndicarMedicoClient from './IndicarMedicoClient';

export default async function IndicarMedicoPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return <IndicarMedicoClient token={token} medicoNome={medicoNome} />;
}
